...
public class RealmsClient
{
    ...
    public RealmsClient(String p_i242127_1_, String p_i242127_2_, Minecraft p_i242127_3_)
    {
        this.field_224947_d = p_i242127_1_;
        this.field_224948_e = p_i242127_2_;
        this.field_244732_f = p_i242127_3_;
        RealmsClientConfig.func_224896_a(p_i242127_3_.getProxy());
    }
