                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            //TODO: Client
                            if (this.player.noClip || Minecraft.getInstance().hackedClient.getModuleManager().getModule("Freecam").getState() || Minecraft.getInstance().hackedClient.getModuleManager().getModule("Phase").getState() || this.player.isSleeping() || (!flag1 || !serverworld.hasNoCollisions(this.player, axisalignedbb)) && !this.func_241163_a_(serverworld, axisalignedbb))
                            {
