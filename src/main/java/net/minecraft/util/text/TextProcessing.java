...
public class TextProcessing
{
    ...
    {
    	//TODO: Client
    	if(Minecraft.getInstance().hackedClient != null) {
    		for(Friend f: Minecraft.getInstance().hackedClient.getFriendManager().getFriendsList()) {
        		if(p_238341_0_.contains(f.getName())) {
        			p_238341_0_.replace(f.getName(), (f.getName() == Minecraft.getInstance().player.getName().getString() ? "\2479" : "\2479") + f.getAlias());
        		}
        	}
    	}
    ...
    public static boolean func_238345_b_(String p_238345_0_, Style p_238345_1_, ICharacterConsumer p_238345_2_)
    {
    	...
    	if(Minecraft.getInstance().hackedClient != null) {
    		for(Friend f: Minecraft.getInstance().hackedClient.getFriendManager().getFriendsList()) {
        		if(p_238345_0_.contains(f.getName())) {
        			p_238345_0_.replace(f.getName(), (f.getName() == Minecraft.getInstance().player.getName().getString() ? "\2479" : "\2479") + f.getAlias());
        		}
        	}
    	}
    ...
    public static boolean func_238340_a_(String p_238340_0_, int p_238340_1_, Style p_238340_2_, Style p_238340_3_, ICharacterConsumer p_238340_4_)
    {
    	...
    	if(Minecraft.getInstance().hackedClient != null) {
    		for(Friend f: Minecraft.getInstance().hackedClient.getFriendManager().getFriendsList()) {
        		if(p_238340_0_.contains(f.getName())) {
        			p_238340_0_.replace(f.getName(), (f.getName() == Minecraft.getInstance().player.getName().getString() ? "\2479" : "\2479") + f.getAlias());
        		}
        	}
    	}
