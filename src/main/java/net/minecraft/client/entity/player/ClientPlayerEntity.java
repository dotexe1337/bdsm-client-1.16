...
public class ClientPlayerEntity extends AbstractClientPlayerEntity
{
    ...
    {
    	//TODO: Client
    	if(mc.hackedClient.getModuleManager().getModule("Freecam").getState() || mc.hackedClient.getModuleManager().getModule("Phase").getState()) {
    		return false;
    	}
    ...
    public void livingTick()
    {
        ...
        //TODO: Client
        if (this.isHandActive() && !this.isPassenger() && !(Minecraft.getInstance().hackedClient.getModuleManager().getModule("NoSlowdown").getState()))
        {
        ...
        //TODO: Client
        if (!this.noClip && !Minecraft.getInstance().hackedClient.getModuleManager().getModule("Freecam").getState() && !mc.hackedClient.getModuleManager().getModule("Phase").getState())
        {
