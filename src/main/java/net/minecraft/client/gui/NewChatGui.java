...
public class NewChatGui extends AbstractGui
{
    ...
    private void func_238493_a_(ITextComponent str, int p_238493_2_, int p_238493_3_, boolean p_238493_4_)
    {
    	//TODO: Kinky O.o
    	String p_238493_1_ = str.getString();
    	if(Minecraft.getInstance().hackedClient.getFriendManager().isFriend(Minecraft.getInstance().player.getName().getString())) {
    		p_238493_1_ = StringUtils.replaceIgnoreCase(p_238493_1_, mc.player.getName().getString(), "\247b" + mc.hackedClient.getFriendManager().getAliasName(mc.player.getName().getString()) + "\247r");
    	}
    	for(Friend f: Minecraft.getInstance().hackedClient.getFriendManager().getFriendsList()) {
    		if(p_238493_1_.toLowerCase().contains(f.getName().toLowerCase())) {
    			p_238493_1_ = StringUtils.replaceIgnoreCase(p_238493_1_, f.getName(), "\2479" + Minecraft.getInstance().hackedClient.getFriendManager().getAliasName(f.getName()) + "\247r");	
    		}
    	}
    	TranslationTextComponent newComponent = new TranslationTextComponent(p_238493_1_);
    	newComponent.setStyle(str.getStyle());
        ...
        //TODO: Client
        List<IReorderingProcessor> list = RenderComponentsUtil.func_238505_a_(newComponent, i, this.mc.fontRenderer);
        ...
        {
        	//TODO: Client
            this.chatLines.add(0, new ChatLine<>(p_238493_3_, newComponent, p_238493_2_));
