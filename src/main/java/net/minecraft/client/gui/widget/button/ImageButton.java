...
public class ImageButton extends Button
{
    ...
    public ImageButton(int p_i242136_1_, int p_i242136_2_, int p_i242136_3_, int p_i242136_4_, int p_i242136_5_, int p_i242136_6_, int p_i242136_7_, ResourceLocation p_i242136_8_, int p_i242136_9_, int p_i242136_10_, Button.IPressable p_i242136_11_, Button.ITooltip p_i242136_12_, ITextComponent p_i242136_13_)
    {
        super(p_i242136_1_, p_i242136_2_, p_i242136_3_, p_i242136_4_, p_i242136_13_, p_i242136_11_, p_i242136_12_);
        this.textureWidth = p_i242136_9_;
        this.textureHeight = p_i242136_10_;
        this.xTexStart = p_i242136_5_;
        this.yTexStart = p_i242136_6_;
        this.yDiffText = p_i242136_7_;
        this.resourceLocation = p_i242136_8_;
    }
