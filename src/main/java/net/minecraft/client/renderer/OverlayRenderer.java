...
public class OverlayRenderer
{
    ...
    public static void renderOverlays(Minecraft minecraftIn, MatrixStack matrixStackIn)
    {
        ...
        //TODO: Client
        if (!playerentity.noClip && !Minecraft.getInstance().hackedClient.getModuleManager().getModule("Freecam").getState() && !Minecraft.getInstance().hackedClient.getModuleManager().getModule("Phase").getState())
        {
        ...
        //TODO: Client
        if (!minecraftIn.player.isSpectator() && !Minecraft.getInstance().hackedClient.getModuleManager().getModule("Freecam").getState() && !Minecraft.getInstance().hackedClient.getModuleManager().getModule("Phase").getState())
        {
