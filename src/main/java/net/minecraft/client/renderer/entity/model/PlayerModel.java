...
public class PlayerModel<T extends LivingEntity> extends BipedModel<T>
{
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        {
        	//TODO: Client
        	if (entityIn.isCrouching() || (entityIn == Minecraft.getInstance().player && Minecraft.getInstance().hackedClient.getModuleManager().getModule("Sneak").getState()))
            {
        ...
        //TODO: Client
        else if (entityIn.isCrouching() || (entityIn == Minecraft.getInstance().player && Minecraft.getInstance().hackedClient.getModuleManager().getModule("Sneak").getState()))
        {
